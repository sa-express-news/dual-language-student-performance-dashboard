...
export default () => (
    <div className="header">
        ...
        <p className="subhead">Use this tool to search and compare Bexar County dual language and English learner (EL) program student performance on STAAR tests. You can search for a school in the search bar, {getScatterPlotDesc()} and filter by all EL or just dual language programs. <em>All data sourced from the Texas Education Agency.</em></p>
